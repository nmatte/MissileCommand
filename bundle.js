...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.fireScud = function (x, y) {
	  ...
	  if (missile.destroyedTarget) {
	    ...
	    var city = this.cities.find(
	      function (someCity) {
	        ...
	        return missile.dest.x <= someCity.location.x + widthVariation && missile.dest.x >= someCity.location.x - widthVariation;
	      }
	    );
	...
	Game.prototype.spawnMissileWave = function (force) {
	  ...
	  if (this.missiles.length < this.maxTotal) {
	    ...
	    for (var i = 0; i < numTimes; i++) {
	      ...
	      this.missiles.push(new Missile(missOrigin, missTarget, this.onMissileFinish.bind(this)));
	...
	Game.prototype.randomizeX = function (x) {
